...
abbrev Pubkey := SVM.Pubkey.Pubkey
abbrev U64 := SVM.Pubkey.U64
abbrev U128 := SVM.Pubkey.U128
abbrev I128 := SVM.Pubkey.I128
abbrev U8 := SVM.Pubkey.U8
abbrev Account := SVM.Pubkey.Account
abbrev canWrite := SVM.Pubkey.canWrite
abbrev findByKey := SVM.Pubkey.findByKey
abbrev findByAuthority := SVM.Pubkey.findByAuthority
abbrev find_map_pred_preserved := SVM.Pubkey.find_map_pred_preserved
abbrev find_map_update_other := SVM.Pubkey.find_map_update_other
abbrev find_map_update_same := SVM.Pubkey.find_map_update_same
abbrev find_by_key_map_update_other := SVM.Pubkey.find_by_key_map_update_other
abbrev find_by_key_map_update_same := SVM.Pubkey.find_by_key_map_update_same

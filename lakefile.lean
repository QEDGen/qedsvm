...
lean_lib Examples where
  ...
  roots := #[`ByteIncrement, `AsmTimeout, `PTokenValidationPrelude, `PTokenTransferArmSetup, `CompilerRtFpCmp, `PTokenTransferArm, `CompilerRtF64ToI64, `PTokenTransferArmTwoCalls, `PTokenTransferArmTwoCallsExt, `PTokenTransferBalanceSpec]
  precompileModules := true

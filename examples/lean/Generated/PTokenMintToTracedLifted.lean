...
theorem PTokenMintTo_lifted_spec
    ...
    : cuTripleWithinMem 119 0 198 3542
      ...
      (effectiveAddr addr6 80 ↦U64 oldMemD_37) **
      (effectiveAddr addr6 1 ↦ₘ oldMemB_38) **
      (effectiveAddr addr5 124 ↦U64 wrapAdd oldMemD_39 oldMemD_36) **
      (effectiveAddr addr4 152 ↦U64 wrapAdd oldMemD_40 oldMemD_36))
  ...
  have h_314 := ldxdw_spec .r7 .r1 0 (vR7Old) (baseAddr) oldMemD_2 314 (by decide) holdMemD_2_lt
  have h_315 := jeq_imm_not_taken_spec .r7 0 (oldMemD_2) 315 418 h_branch2
  have h_316 := stxdw_spec .r10 .r0 (-2072) (vR10Old) (wrapAdd baseAddr (toU64 8)) oldMemD_3 316
  ...
  have h_321 := jeq_imm_not_taken_spec .r7 1 (oldMemD_2) 321 330 h_branch3
  have h_322 := jne_imm_taken_spec .r7 2 (oldMemD_2) 322 3361 h_branch4
  ...
  have h_3363 := mov64_reg_spec .r3 .r7 (vR3Old) (oldMemD_2) 3363 (by decide)
  have h_3364 := jlt_imm_taken_spec .r7 6 (oldMemD_2) 3364 3453 h_branch5
  have h_3453 := jsle_imm_not_taken_spec .r3 2 (oldMemD_2) 3453 3578 h_branch6
  have h_3454 := jeq_imm_taken_spec .r3 3 (oldMemD_2) 3454 3585 h_branch7
  have h_3585 := ldxb_spec .r3 .r1 0 (oldMemD_2) (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemB_4 3585 (by decide)
  have h_3586 := jne_imm_not_taken_spec .r3 255 (oldMemB_4 % 256) 3586 5265 h_branch8
  have h_3587 := stxdw_spec .r2 .r1 8 (wrapAdd vR10Old (toU64 (-2072))) (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_5 3587
  have h_3588 := ldxdw_spec .r3 .r1 80 (oldMemB_4 % 256) (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6 3588 (by decide) holdMemD_6_lt
  have h_3589 := add64_reg_spec .r1 .r3 (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) (oldMemD_6) 3589 (by decide)
  have h_3590 := add64_imm_spec .r1 10343 (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) 3590 (by decide)
  have h_3591 := and64_imm_spec .r1 (-8) (wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) (toU64 10343)) 3591 (by decide)
  have h_3592 := ldxb_spec .r3 .r1 0 (oldMemD_6) (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) oldMemB_7 3592 (by decide)
  have h_3593 := jne_imm_not_taken_spec .r3 255 (oldMemB_7 % 256) 3593 5274 h_branch9
  have h_3594 := stxdw_spec .r2 .r1 16 (wrapAdd vR10Old (toU64 (-2072))) (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_8 3594
  have h_3595 := ja_spec 326 3595
  have h_326 := ldxdw_spec .r2 .r1 80 (wrapAdd vR10Old (toU64 (-2072))) (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_9 326 (by decide) holdMemD_9_lt
  have h_327 := add64_reg_spec .r1 .r2 (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) (oldMemD_9) 327 (by decide)
  have h_328 := add64_imm_spec .r1 10343 (wrapAdd (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_9) 328 (by decide)
  have h_329 := and64_imm_spec .r1 (-8) (wrapAdd (wrapAdd (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_9) (toU64 10343)) 329 (by decide)
  have h_330 := mov64_reg_spec .r4 .r0 (vR4Old) (wrapAdd baseAddr (toU64 8)) 330 (by decide)
  have h_331 := mov64_reg_spec .r0 .r1 (wrapAdd baseAddr (toU64 8)) (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_9) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) 331 (by decide)
  have h_332 := ldxdw_spec .r9 .r0 0 (vR9Old) (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_9) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_10 332 (by decide) holdMemD_10_lt
  have h_333 := jeq_imm_not_taken_spec .r9 0 (oldMemD_10) 333 420 h_branch10
  have h_334 := ldxb_spec .r5 .r0 8 (vR5Old) (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_9) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) oldMemB_11 334 (by decide)
  have h_335 := jeq_imm_not_taken_spec .r5 255 (oldMemB_11 % 256) 335 423 h_branch11
  have h_336 := add64_imm_spec .r9 (-1) (oldMemD_10) 336 (by decide)
  have h_337 := mov64_reg_spec .r8 .r0 (vR8Old) (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_9) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) 337 (by decide)
  have h_338 := add64_imm_spec .r8 9 (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_9) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) 338 (by decide)
  have h_339 := jsgt_imm_not_taken_spec .r5 11 (oldMemB_11 % 256) 339 3474 h_branch12
  have h_340 := jsgt_imm_taken_spec .r5 6 (oldMemB_11 % 256) 340 3543 h_branch13
  have h_3543 := jeq_imm_taken_spec .r5 7 (oldMemB_11 % 256) 3543 3654 h_branch14
  have h_3654 := jlt_imm_not_taken_spec .r9 8 (wrapAdd oldMemD_10 (toU64 (-1))) 3654 3944 h_branch15
  have h_3655 := jlt_imm_not_taken_spec .r7 3 (oldMemD_2) 3655 3947 h_branch16
  have h_3656 := mov64_imm_spec .r6 3 (vR6Old) 3656 (by decide)
  have h_3657 := mov64_imm_spec .r9 0 (wrapAdd oldMemD_10 (toU64 (-1))) 3657 (by decide)
  have h_3658 := ldxdw_spec .r3 .r10 (-2064) (oldMemB_7 % 256) (vR10Old) oldMemD_12 3658 (by decide) holdMemD_12_lt
  have h_3659 := ldxdw_spec .r1 .r3 80 (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_9) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) (oldMemD_12) oldMemD_13 3659 (by decide) holdMemD_13_lt
  have h_3660 := jne_imm_not_taken_spec .r1 165 (oldMemD_13) 3660 3536 h_branch17
  have h_3661 := ldxb_spec .r1 .r3 196 (oldMemD_13) (oldMemD_12) oldMemB_14 3661 (by decide)
  have h_3662 := jgt_imm_not_taken_spec .r1 2 (oldMemB_14 % 256) 3662 3536 h_branch18
  have h_3663 := jeq_imm_not_taken_spec .r1 2 (oldMemB_14 % 256) 3663 3974 h_branch19
  have h_3664 := jeq_imm_not_taken_spec .r1 0 (oldMemB_14 % 256) 3664 4916 h_branch20
  have h_3665 := mov64_imm_spec .r6 0 (toU64 3) 3665 (by decide)
  have h_3666 := ldxb_spec .r1 .r3 197 (oldMemB_14 % 256) (oldMemD_12) oldMemB_15 3666 (by decide)
  have h_3667 := jeq_imm_not_taken_spec .r1 1 (oldMemB_15 % 256) 3667 5361 h_branch21
  have h_3668 := mov64_imm_spec .r9 3 (toU64 0) 3668 (by decide)
  have h_3669 := ldxdw_spec .r1 .r3 88 (oldMemB_15 % 256) (oldMemD_12) oldMemD_16 3669 (by decide) holdMemD_16_lt
  have h_3670 := ldxdw_spec .r2 .r4 8 (oldMemD_9) (wrapAdd baseAddr (toU64 8)) oldMemD_17 3670 (by decide) holdMemD_17_lt
  have h_3671 := jne_reg_not_taken_spec .r2 .r1 (oldMemD_17) (oldMemD_16) 3671 3536 h_branch22
  have h_3672 := ldxdw_spec .r1 .r3 96 (oldMemD_16) (oldMemD_12) oldMemD_18 3672 (by decide) holdMemD_18_lt
  have h_3673 := ldxdw_spec .r2 .r4 16 (oldMemD_17) (wrapAdd baseAddr (toU64 8)) oldMemD_19 3673 (by decide) holdMemD_19_lt
  have h_3674 := jne_reg_not_taken_spec .r2 .r1 (oldMemD_19) (oldMemD_18) 3674 3536 h_branch23
  have h_3675 := mov64_reg_spec .r0 .r7 (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_9) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) (oldMemD_2) 3675 (by decide)
  have h_3676 := ldxdw_spec .r1 .r3 104 (oldMemD_18) (oldMemD_12) oldMemD_20 3676 (by decide) holdMemD_20_lt
  have h_3677 := ldxdw_spec .r2 .r4 24 (oldMemD_19) (wrapAdd baseAddr (toU64 8)) oldMemD_21 3677 (by decide) holdMemD_21_lt
  have h_3678 := jne_reg_not_taken_spec .r2 .r1 (oldMemD_21) (oldMemD_20) 3678 3536 h_branch24
  have h_3679 := ldxdw_spec .r1 .r3 112 (oldMemD_20) (oldMemD_12) oldMemD_22 3679 (by decide) holdMemD_22_lt
  have h_3680 := mov64_reg_spec .r7 .r4 (oldMemD_2) (wrapAdd baseAddr (toU64 8)) 3680 (by decide)
  have h_3681 := ldxdw_spec .r2 .r4 32 (oldMemD_21) (wrapAdd baseAddr (toU64 8)) oldMemD_23 3681 (by decide) holdMemD_23_lt
  have h_3682 := jne_reg_not_taken_spec .r2 .r1 (oldMemD_23) (oldMemD_22) 3682 3536 h_branch25
  ...
  have h_3685 := ldxdw_spec .r1 .r4 80 (oldMemD_22) (wrapAdd baseAddr (toU64 8)) oldMemD_24 3685 (by decide) holdMemD_24_lt
  have h_3686 := jne_imm_not_taken_spec .r1 82 (oldMemD_24) 3686 4800 h_branch26
  have h_3687 := ldxb_spec .r1 .r4 133 (oldMemD_24) (wrapAdd baseAddr (toU64 8)) oldMemB_25 3687 (by decide)
  have h_3688 := jne_imm_not_taken_spec .r1 1 (oldMemB_25 % 256) 3688 4799 h_branch27
  have h_3689 := ldxb_spec .r1 .r4 88 (oldMemB_25 % 256) (wrapAdd baseAddr (toU64 8)) oldMemB_26 3689 (by decide)
  have h_3690 := jne_imm_not_taken_spec .r1 1 (oldMemB_26 % 256) 3690 4911 h_branch28
  have h_3691 := mov64_imm_spec .r9 4 (toU64 0) 3691 (by decide)
  have h_3692 := ldxdw_spec .r5 .r10 (-2056) (oldMemB_11 % 256) (vR10Old) oldMemD_27 3692 (by decide) holdMemD_27_lt
  have h_3693 := ldxdw_spec .r1 .r5 8 (oldMemB_26 % 256) (oldMemD_27) oldMemD_28 3693 (by decide) holdMemD_28_lt
  have h_3694 := ldxdw_spec .r2 .r4 92 (oldMemD_23) (wrapAdd baseAddr (toU64 8)) oldMemD_29 3694 (by decide) holdMemD_29_lt
  have h_3695 := jne_reg_not_taken_spec .r2 .r1 (oldMemD_29) (oldMemD_28) 3695 3536 h_branch29
  have h_3696 := ldxdw_spec .r1 .r5 16 (oldMemD_28) (oldMemD_27) oldMemD_30 3696 (by decide) holdMemD_30_lt
  have h_3697 := ldxdw_spec .r2 .r4 100 (oldMemD_29) (wrapAdd baseAddr (toU64 8)) oldMemD_31 3697 (by decide) holdMemD_31_lt
  have h_3698 := jne_reg_not_taken_spec .r2 .r1 (oldMemD_31) (oldMemD_30) 3698 3536 h_branch30
  have h_3699 := ldxdw_spec .r1 .r5 24 (oldMemD_30) (oldMemD_27) oldMemD_32 3699 (by decide) holdMemD_32_lt
  have h_3700 := ldxdw_spec .r2 .r4 108 (oldMemD_31) (wrapAdd baseAddr (toU64 8)) oldMemD_33 3700 (by decide) holdMemD_33_lt
  have h_3701 := jne_reg_not_taken_spec .r2 .r1 (oldMemD_33) (oldMemD_32) 3701 3536 h_branch31
  have h_3702 := ldxdw_spec .r1 .r5 32 (oldMemD_32) (oldMemD_27) oldMemD_34 3702 (by decide) holdMemD_34_lt
  have h_3703 := ldxdw_spec .r2 .r4 116 (oldMemD_33) (wrapAdd baseAddr (toU64 8)) oldMemD_35 3703 (by decide) holdMemD_35_lt
  have h_3704 := jne_reg_not_taken_spec .r2 .r1 (oldMemD_35) (oldMemD_34) 3704 3536 h_branch32
  have h_3705 := ldxdw_spec .r4 .r8 0 (wrapAdd baseAddr (toU64 8)) (wrapAdd (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_6) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_9) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS) (toU64 9)) oldMemD_36 3705 (by decide) holdMemD_36_lt
  have h_3706 := ldxdw_spec .r1 .r5 80 (oldMemD_34) (oldMemD_27) oldMemD_37 3706 (by decide) holdMemD_37_lt
  have h_3707 := jne_imm_taken_spec .r1 355 (oldMemD_37) 3707 4743 h_branch33
  have h_4743 := ldxb_spec .r1 .r5 1 (oldMemD_37) (oldMemD_27) oldMemB_38 4743 (by decide)
  have h_4744 := jeq_imm_not_taken_spec .r1 0 (oldMemB_38 % 256) 4744 6337 h_branch34
  have h_4745 := jeq_imm_not_taken_spec .r4 0 (oldMemD_36) 4745 4760 h_branch35
  have h_4746 := ldxdw_spec .r5 .r7 124 (oldMemD_27) (wrapAdd baseAddr (toU64 8)) oldMemD_39 4746 (by decide) holdMemD_39_lt
  have h_4747 := mov64_reg_spec .r1 .r5 (oldMemB_38 % 256) (oldMemD_39) 4747 (by decide)
  have h_4748 := add64_reg_spec .r1 .r4 (oldMemD_39) (oldMemD_36) 4748 (by decide)
  have h_4749 := mov64_imm_spec .r2 1 (oldMemD_35) 4749 (by decide)
  have h_4750 := jlt_reg_not_taken_spec .r1 .r5 (wrapAdd oldMemD_39 oldMemD_36) (oldMemD_39) 4750 4752 h_branch36
  ...
  have h_4754 := stxdw_spec .r7 .r1 124 (wrapAdd baseAddr (toU64 8)) (wrapAdd oldMemD_39 oldMemD_36) oldMemD_39 4754
  have h_4755 := ldxdw_spec .r1 .r3 152 (wrapAdd oldMemD_39 oldMemD_36) (oldMemD_12) oldMemD_40 4755 (by decide) holdMemD_40_lt
  have h_4756 := add64_reg_spec .r1 .r4 (oldMemD_40) (oldMemD_36) 4756 (by decide)
  have h_4757 := stxdw_spec .r3 .r1 152 (oldMemD_12) (wrapAdd oldMemD_40 oldMemD_36) oldMemD_40 4757
  have h_4758 := mov64_imm_spec .r0 0 (oldMemD_2) 4758 (by decide)

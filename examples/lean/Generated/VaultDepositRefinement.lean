/-
  ...
  Input-layout assumption: aligned non-duplicate accounts with data lengths [41],
  tracked account index 0. Codec offsets below are relative to entry r1.
...
theorem refines_asm
    ...
    SVM.Solana.Abstract.AsmRefinesFieldUpdate cr 5 0 0 5 rr baseAddr
      [(96, .pubkey ⟨o0, o1, o2, o3⟩), (128, .u64 oldMemD_1), (136, .byte fb4)]
      [(96, .pubkey ⟨o0, o1, o2, o3⟩), (128, .u64 (oldMemD_1 + oldMemD_0)), (136, .byte fb4)]
      ((.r1 ↦ᵣ baseAddr) **
      (effectiveAddr baseAddr 10400 ↦U64 oldMemD_0) **
      (.r2 ↦ᵣ vR2Old) **
      (.r3 ↦ᵣ vR3Old) **
  ...
  have framed := cuTripleWithinMem_frame_right
    ( (effectiveAddr baseAddr 96 ↦U64 o0) **
      (effectiveAddr baseAddr 104 ↦U64 o1) **
      (effectiveAddr baseAddr 112 ↦U64 o2) **
      (effectiveAddr baseAddr 120 ↦U64 o3) **
      (effectiveAddr baseAddr 136 ↦ₘ fb4) )
    (by sl_pcfree) lift
  sl_exact framed

/-- qedgen `ensures`-shape, mechanically discharged: the mutated `u64`
    field (offset 128) shifts by oldMemD_0. Pairs with `refines_asm`
...
theorem ensures
    ...
    u64FieldAt 128 [(96, .pubkey ⟨o0, o1, o2, o3⟩), (128, .u64 (oldMemD_1 + oldMemD_0)), (136, .byte fb4)]
      = u64FieldAt 128 [(96, .pubkey ⟨o0, o1, o2, o3⟩), (128, .u64 oldMemD_1), (136, .byte fb4)] + oldMemD_0 := by
  qedsvm_discharge

...
-- The byte→insn link is pinned instead by `PTokenTransfer_decode_pins` below:
...
theorem PTokenTransfer_decode_pins :
    ([1800, 1808, 2688, 2696, 2704, 2712, 2720, 2728, 2736, 2744, 34248, 34256, 34264, 34272, 34280, 34288, 
      ...
      some (.jeq .r2 (.imm (0)) 5225, 8),
      some (.sub64 .r3 (.reg .r2), 8),
      some (.stx .dword .r1 160 .r3, 8),
      some (.ldx .dword .r3 .r1 10664, 8),
      some (.add64 .r3 (.reg .r2), 8),
      some (.stx .dword .r1 10664 .r3, 8),

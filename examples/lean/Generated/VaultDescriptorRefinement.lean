/-
  ...
  from a qedspec-shaped refinement descriptor (account vault, handler increment,
...
import Generated.VaultDescriptorTracedLifted

namespace Examples.VaultDescriptorRefinement
...
end Examples.VaultDescriptorRefinement

/-
  ...
  from a qedspec-shaped refinement descriptor (account vault, handler deposit_const,
...
import Generated.VaultAdd5TracedLifted

namespace Examples.VaultAdd5Refinement
...
theorem refines_asm
    ...
    (lift : cuTripleWithinMem 4 0 0 4 cr
      ...
      (.r0 ↦ᵣ vR0Old))
      ((.r1 ↦ᵣ baseAddr) **
      (effectiveAddr baseAddr 32 ↦U64 oldMemD_0 + 5) **
      (.r2 ↦ᵣ wrapAdd oldMemD_0 (toU64 5)) **
      (.r0 ↦ᵣ toU64 0)) rr) :
    SVM.Solana.Abstract.AsmRefinesFieldUpdate cr 4 0 0 4 rr baseAddr
      [(0, .pubkey ⟨o0, o1, o2, o3⟩), (32, .u64 oldMemD_0), (40, .byte fb4)]
      [(0, .pubkey ⟨o0, o1, o2, o3⟩), (32, .u64 (oldMemD_0 + 5)), (40, .byte fb4)]
      ((.r1 ↦ᵣ baseAddr) **
      (.r2 ↦ᵣ vR2Old) **
      (.r0 ↦ᵣ vR0Old))
      ((.r1 ↦ᵣ baseAddr) **
...
/-- qedgen `ensures`-shape, mechanically discharged: the mutated `u64`
    field (offset 32) shifts by 5. Pairs with `refines_asm`
...
theorem ensures
    ...
    u64FieldAt 32 [(0, .pubkey ⟨o0, o1, o2, o3⟩), (32, .u64 (oldMemD_0 + 5)), (40, .byte fb4)]
      = u64FieldAt 32 [(0, .pubkey ⟨o0, o1, o2, o3⟩), (32, .u64 oldMemD_0), (40, .byte fb4)] + 5 := by
  qedsvm_discharge

end Examples.VaultAdd5Refinement

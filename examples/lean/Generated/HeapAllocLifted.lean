...
def HeapAllocBytes : ByteArray := ⟨#[
  ...
  0x18, 0x03, 0x00, 0x00, 0xf0, 0x7f, 0x00, 0x00, 
  0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 
  0x7b, 0x31, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
  0x07, 0x02, 0x00, 0x00, 0x2a, 0x00, 0x00, 0x00, 
  0x7b, 0x23, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
theorem HeapAlloc_lifted_spec
    (baseAddr oldMemD_0 vR2Old vR3Old oldMemD_1 vR0Old : Nat)
    (holdMemD_0_lt : oldMemD_0 < 2 ^ 64)
    (hReloadLt_6 : wrapAdd oldMemD_0 (toU64 42) < 2 ^ 64)
    : cuTripleWithinMem 8 0 0 8
      (((((((((CodeReq.singleton 0 (.lddw .r1 (12884901888))).union
        (CodeReq.singleton 1 (.ldx .dword .r2 .r1 0))).union
        (CodeReq.singleton 2 (.lddw .r3 (12884934640)))).union
        (CodeReq.singleton 3 (.stx .dword .r1 0 .r3))).union
        (CodeReq.singleton 4 (.add64 .r2 (.imm (42))))).union
        (CodeReq.singleton 5 (.stx .dword .r3 0 .r2))).union
        (CodeReq.singleton 6 (.ldx .dword .r1 .r3 0))).union
      ...
      (.r0 ↦ᵣ vR0Old))
      ((.r1 ↦ᵣ wrapAdd oldMemD_0 (toU64 42)) **
      (effectiveAddr (toU64 12884901888) 0 ↦U64 toU64 12884934640) **
      (.r2 ↦ᵣ wrapAdd oldMemD_0 (toU64 42)) **
      (.r3 ↦ᵣ toU64 12884934640) **
      (effectiveAddr (toU64 12884934640) 0 ↦U64 wrapAdd oldMemD_0 (toU64 42)) **
      (.r0 ↦ᵣ toU64 0))

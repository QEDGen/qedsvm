/-
  Whole-transition bundle for guarded_oob (#40 gap 1). MECHANICALLY EMITTED
  by qedlift from the per-path trace-guided lifts (one discovered
  `guarded_oob_<path>.pcs` trace per path) + the refinement descriptor. ONE
...
import Generated.GuardedOobOobLifted
import Generated.GuardedOobSuccessLifted

namespace Examples.GuardedOobTransition
...
theorem guarded_oob_transition
    ...
    (amount ≠ toU64 0 →
      ...
      (((((((((CodeReq.singleton 0 (.ldx .dword .r2 .r1 0)).union
        ...
        (CodeReq.singleton 6 (.ja 10)))).union

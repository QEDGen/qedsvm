...
namespace Examples.Lifted.PTokenTransferSrcBadState

open SVM.SBPF

-- NOTE: `PTokenTransferSrcBadStateBytes` + `PTokenTransferSrcBadStateInsns` + `PTokenTransferSrcBadState_decodes` omitted — the .text
-- is 102608 bytes, which blows `maxRecDepth` as a ByteArray literal.
-- The byte→insn link is pinned instead by `PTokenTransferSrcBadState_decode_pins` below:
...
theorem PTokenTransferSrcBadState_decode_pins :
    ([1800, 1808, 2688, 2696, 2704, 2712, 2720, 2728, 2736, 2744, 34248, 34256, 34264, 34272, 34280, 34288, 
      34296, 34304, 34312, 34320, 34328, 34336, 34344, 34352, 40624, 40632, 40640, 58856, 58864, 58872, 58880, 59008, 
      59216, 59536, 59552, 59560, 60072, 60080, 40648, 40656, 40664, 30376, 936, 944, 952, 960, 968, 1080, 
      1272, 1536, 1552, 1792].map fun off =>
...
open Memory in
theorem PTokenTransferSrcBadState_lifted_spec
    ...
    : cuTripleWithinMem 52 nCuLog9 198 3542
  ...
  have h_4004 := jgt_imm_taken_spec .r3 2 (oldMemB_8 % 256) 4004 4725 h_branch7
  ...
  have h_6866 := jsgt_imm_not_taken_spec .r1 12 ((((toU64 3) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 6866 6874 h_branch8
  have h_6867 := jsle_imm_taken_spec .r1 5 ((((toU64 3) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 6867 6881 h_branch9
  have h_6881 := jsgt_imm_taken_spec .r1 2 ((((toU64 3) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 6881 6903 h_branch10
  have h_6903 := jeq_imm_taken_spec .r1 3 ((((toU64 3) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 6903 6936 h_branch11
  ...
  have h_6988 := call_sol_log_spec vR0Old (toU64 4295070447) (toU64 25) 6988 nCuLog9 hCuLog9
  ...
  have h_119 := jsgt_imm_not_taken_spec .r1 12 ((((toU64 3) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 119 126 h_branch12
  have h_120 := jsle_imm_taken_spec .r1 5 ((((toU64 3) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 120 132 h_branch13
  have h_132 := jsgt_imm_taken_spec .r1 2 ((((toU64 3) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 132 151 h_branch14
  have h_151 := jeq_imm_taken_spec .r1 3 ((((toU64 3) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 151 176 h_branch15
  ...
  dsimp only at h_197
  sl_rw_abs [h_addr0] at [h_198, h_199, h_304, h_305, h_306, h_307, h_308, h_309, h_310, h_311, h_3991, h_3992, h_3993, h_3994, h_3995, h_3996, h_3997, h_3998, h_3999, h_4000, h_4001, h_4002, h_4003, h_4004, h_4725, h_4726, h_4727, h_6864, h_6865, h_6866, h_6867, h_6881, h_6903, h_6936, h_6937, h_6938, h_6988, h_6989, h_4728, h_4729, h_4730, h_3541, h_116, h_117, h_118, h_119, h_120, h_132, h_151, h_176, h_177, h_197]
  sl_block_iter [h_198, h_199, h_304, h_305, h_306, h_307, h_308, h_309, h_310, h_311, h_3991, h_3992, h_3993, h_3994, h_3995, h_3996, h_3997, h_3998, h_3999, h_4000, h_4001, h_4002, h_4003, h_4004, h_4725, h_4726, h_4727, h_6864, h_6865, h_6866, h_6867, h_6881, h_6903, h_6936, h_6937, h_6938, h_6988, h_6989, h_4728, h_4729, h_4730, h_3541, h_116, h_117, h_118, h_119, h_120, h_132, h_151, h_176, h_177, h_197] generalizing [(((toU64 3) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64), oldMemB_8 % 256]
...
example :
      ...
      (0 < 2 ^ 64) ∧
      (9 < 2 ^ 64) := by
  refine ⟨?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_⟩ <;> native_decide

end Examples.Lifted.PTokenTransferSrcBadState

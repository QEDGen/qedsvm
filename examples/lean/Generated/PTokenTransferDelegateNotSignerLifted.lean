...
namespace Examples.Lifted.PTokenTransferDelegateNotSigner

open SVM.SBPF

-- NOTE: `PTokenTransferDelegateNotSignerBytes` + `PTokenTransferDelegateNotSignerInsns` + `PTokenTransferDelegateNotSigner_decodes` omitted — the .text
-- is 102608 bytes, which blows `maxRecDepth` as a ByteArray literal.
-- The byte→insn link is pinned instead by `PTokenTransferDelegateNotSigner_decode_pins` below:
...
theorem PTokenTransferDelegateNotSigner_decode_pins :
    ([1800, 1808, 2688, 2696, 2704, 2712, 2720, 2728, 2736, 2744, 34248, 34256, 34264, 34272, 34280, 34288, 
      ...
      45032, 49272, 49280, 40624, 40632, 40640, 58856, 58864, 58872, 58880, 58888, 59120, 59128, 59136, 59152, 59160, 
      60072, 60080, 40648, 40656, 40664, 30376, 936, 944, 952, 960, 968, 976, 1192, 1200, 1208, 1224, 
      1792].map fun off =>
...
open Memory in
theorem PTokenTransferDelegateNotSigner_lifted_spec
    ...
    : cuTripleWithinMem 97 nCuLog30 198 3542
  ...
  have h_5216 := jeq_imm_taken_spec .r4 0 (oldMemB_29 % 256) 5216 5716 h_branch24
  ...
  have h_4727 := call_local_spec 6864 [] (toU64 7) (toU64 1) (oldMemD_28) (vR9Old) (vR10Old) 4727
  ...
  have h_6896 := mov64_imm_spec .r2 31 (toU64 1) 6896 (by decide)
  have h_6897 := ja_spec 6988 6897
  have h_6988 := call_sol_log_spec oldMemD_27 (toU64 4295070547) (toU64 31) 6988 nCuLog30 hCuLog30
  have h_6989 := exit_pops_spec ⟨4727 + 1, ((toU64 7)), ((toU64 1)), (oldMemD_28), (vR9Old), (vR10Old)⟩ [] (toU64 7) (toU64 1) (oldMemD_28) (vR9Old) (vR10Old + 4096) 6989
  dsimp only at h_6989
  have h_4728 := mov64_reg_spec .r1 .r6 (toU64 4295070547) (toU64 7) 4728 (by decide)
  have h_4729 := mov64_reg_spec .r2 .r7 (toU64 31) (toU64 1) 4729 (by decide)
  have h_4730 := ja_spec 3541 4730
  have h_3541 := call_local_spec 116 [] (toU64 7) (toU64 1) (oldMemD_28) (vR9Old) (vR10Old) 3541
...
end Examples.Lifted.PTokenTransferDelegateNotSigner

...
namespace Examples.Lifted.PTokenTransferDestUninit

open SVM.SBPF

-- NOTE: `PTokenTransferDestUninitBytes` + `PTokenTransferDestUninitInsns` + `PTokenTransferDestUninit_decodes` omitted — the .text
-- is 102608 bytes, which blows `maxRecDepth` as a ByteArray literal.
-- The byte→insn link is pinned instead by `PTokenTransferDestUninit_decode_pins` below:
...
theorem PTokenTransferDestUninit_decode_pins :
    ([1800, 1808, 2688, 2696, 2704, 2712, 2720, 2728, 2736, 2744, 34248, 34256, 34264, 34272, 34280, 34288, 
      34296, 34304, 34312, 34320, 34328, 34336, 34344, 34352, 34360, 34368, 34376, 34384, 43768, 43776, 40624, 40632, 
      40640, 58856, 58864, 58872, 58880, 58888, 58896, 58904, 58912, 58928, 58936, 60072, 60080, 40648, 40656, 40664, 
      30376, 936, 944, 952, 960, 968, 976, 984, 992, 1000, 1016, 1792].map fun off =>
...
open Memory in
theorem PTokenTransferDestUninit_lifted_spec
    ...
    : cuTripleWithinMem 60 nCuLog10 198 3542
  ...
  have h_4008 := jeq_imm_taken_spec .r5 0 (oldMemB_9 % 256) 4008 5080 h_branch10
  ...
  have h_6866 := jsgt_imm_not_taken_spec .r1 12 ((((toU64 9) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 6866 6874 h_branch11
  have h_6867 := jsle_imm_not_taken_spec .r1 5 ((((toU64 9) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 6867 6881 h_branch12
  have h_6868 := jsle_imm_not_taken_spec .r1 8 ((((toU64 9) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 6868 6893 h_branch13
  have h_6869 := jsgt_imm_not_taken_spec .r1 10 ((((toU64 9) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 6869 6913 h_branch14
  have h_6870 := jne_imm_not_taken_spec .r1 9 ((((toU64 9) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 6870 6948 h_branch15
  ...
  have h_6988 := call_sol_log_spec vR0Old (toU64 4295070712) (toU64 27) 6988 nCuLog10 hCuLog10
  ...
  have h_119 := jsgt_imm_not_taken_spec .r1 12 ((((toU64 9) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 119 126 h_branch16
  have h_120 := jsle_imm_not_taken_spec .r1 5 ((((toU64 9) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 120 132 h_branch17
  have h_121 := jsle_imm_not_taken_spec .r1 8 ((((toU64 9) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 121 143 h_branch18
  have h_122 := jsgt_imm_not_taken_spec .r1 10 ((((toU64 9) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 122 159 h_branch19
  have h_123 := jne_imm_not_taken_spec .r1 9 ((((toU64 9) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) 123 184 h_branch20
  ...
  dsimp only at h_197
  sl_rw_abs [h_addr0] at [h_198, h_199, h_304, h_305, h_306, h_307, h_308, h_309, h_310, h_311, h_3991, h_3992, h_3993, h_3994, h_3995, h_3996, h_3997, h_3998, h_3999, h_4000, h_4001, h_4002, h_4003, h_4004, h_4005, h_4006, h_4007, h_4008, h_5080, h_5081, h_4725, h_4726, h_4727, h_6864, h_6865, h_6866, h_6867, h_6868, h_6869, h_6870, h_6871, h_6872, h_6873, h_6988, h_6989, h_4728, h_4729, h_4730, h_3541, h_116, h_117, h_118, h_119, h_120, h_121, h_122, h_123, h_124, h_125, h_197]
  sl_block_iter [h_198, h_199, h_304, h_305, h_306, h_307, h_308, h_309, h_310, h_311, h_3991, h_3992, h_3993, h_3994, h_3995, h_3996, h_3997, h_3998, h_3999, h_4000, h_4001, h_4002, h_4003, h_4004, h_4005, h_4006, h_4007, h_4008, h_5080, h_5081, h_4725, h_4726, h_4727, h_6864, h_6865, h_6866, h_6867, h_6868, h_6869, h_6870, h_6871, h_6872, h_6873, h_6988, h_6989, h_4728, h_4729, h_4730, h_3541, h_116, h_117, h_118, h_119, h_120, h_121, h_122, h_123, h_124, h_125, h_197] generalizing [(((toU64 9) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64), oldMemB_8 % 256, oldMemB_9 % 256]
...
example :
      ...
      (0 < 2 ^ 64) ∧
      (9 < 2 ^ 64) := by
  refine ⟨?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_, ?_⟩ <;> native_decide

end Examples.Lifted.PTokenTransferDestUninit

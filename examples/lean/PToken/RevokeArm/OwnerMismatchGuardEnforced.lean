/-
  Pattern library Layer 3 — the OWNER guard on the real p-token Revoke
  arm: only the account owner may revoke a delegation.
  ...
  with r0 = 4 (TokenError::OwnerMismatch), the delegate fields
  untouched.
-/

import Generated.PTokenRevokeOwnerMismatchLifted
import Lean
import SVM.Solana.Patterns.Guards

namespace Examples.PTokenRevokeOwnerMismatchGuard

open SVM.SBPF
open Memory
open Examples.Lifted.PTokenRevokeOwnerMismatch

set_option maxHeartbeats 1600000 in
/-- From a signing non-owner, the real p-token Revoke HALTS with
    `exitCode = some 4` (TokenError::OwnerMismatch) — the owner check is
    ENFORCED on the Revoke arm. -/
theorem p_token_revoke_owner_mismatch_enforced
    (baseAddr oldMemB_0 vR2Old vR0Old oldMemB_1 oldMemB_2 oldMemB_3 oldMemB_4 oldMemB_5 oldMemB_6 oldMemB_7 vR7Old vR10Old oldMemD_8 oldMemD_9 oldMemB_10 oldMemD_11 oldMemD_12 vR4Old oldMemD_13 vR9Old oldMemB_14 vR5Old vR8Old vR3Old vR6Old oldMemB_15 oldMemB_16 oldMemD_17 oldMemD_18 oldMemD_19 oldMemD_20 oldMemD_21 : Nat)
    (addr0 : Nat)
    (addr1 : Nat)
    (addr2 : Nat)
    (addr3 : Nat)
    ...
    (h_addr3 : addr3 = wrapAdd (addr0) (toU64 8))
    ...
    (h_branch24 : oldMemB_16 % 256 = toU64 1)
    (h_branch25 : oldMemD_18 ≠ oldMemD_17)
    (h_branch26 : oldMemD_19 ≠ oldMemD_17)
    (h_branch27 : (((toU64 0) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) ≠ toU64 26)
    ...
    (h_branch32 : (((toU64 4) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) < toU64 20)
    (h_branch33 : ((((((toU64 4) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) &&& toU64 27) % U64_MODULUS = toU64 26)
    ...
    (h_branch38 : (((toU64 4) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) ≠ toU64 0)
    ...
    (hReloadLt_7182 : ((wrapAdd (wrapAdd baseAddr oldMemD_9) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS < 2 ^ 64)
    (h_alias_7182 : effectiveAddr (wrapAdd vR10Old (toU64 (-2072))) (8) = effectiveAddr (vR10Old) (-2064))
    (nCuLog22 : Nat)
    (hCuLog22 : ∀ s : State, (step (.call .sol_log_) s).cuConsumed ≤ s.cuConsumed + nCuLog22)
    : SVM.Solana.Patterns.EnforcedError (128 + 1) nCuLog22 198
      ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((CodeReq.singleton 198 (.ldx .byte .r2 .r1 0)).union
        ...
        (CodeReq.singleton 7182 (.ldx .dword .r4 .r6 8))).union
        (CodeReq.singleton 7183 (.mov64 .r5 (.reg .r4)))).union
        (CodeReq.singleton 7184 (.add64 .r5 (.imm (8))))).union
        (CodeReq.singleton 7185 (.ldx .byte .r1 .r3 160))).union
        (CodeReq.singleton 7186 (.jne .r1 (.imm (1)) 7967))).union
        (CodeReq.singleton 7187 (.ldx .dword .r1 .r5 0))).union
        (CodeReq.singleton 7188 (.ldx .dword .r7 .r3 164))).union
        (CodeReq.singleton 7189 (.jne .r7 (.reg .r1) 8498))).union
        (CodeReq.singleton 8498 (.ldx .dword .r5 .r3 120))).union
        (CodeReq.singleton 8499 (.jne .r5 (.reg .r1) 9345))).union
      ...
      (effectiveAddr addr2 160 ↦ₘ oldMemB_16) **
      (effectiveAddr addr3 0 ↦U64 oldMemD_17) **
      (effectiveAddr addr2 164 ↦U64 oldMemD_18) **
      (effectiveAddr addr2 120 ↦U64 oldMemD_19) **
      ...
      (fun rt => (((((((((((((((((((rt.containsRange (effectiveAddr baseAddr 0) 1 = true) ∧
                  ...
                  rt.containsRange (effectiveAddr addr2 160) 1 = true) ∧
                  rt.containsRange (effectiveAddr addr3 0) 8 = true) ∧
                  rt.containsRange (effectiveAddr addr2 164) 8 = true) ∧
                  rt.containsRange (effectiveAddr addr2 120) 8 = true) ∧
      ...
      4 := by
  refine ⟨by decide, ?_⟩
  have h := PTokenRevokeOwnerMismatch_lifted_spec baseAddr oldMemB_0 vR2Old vR0Old oldMemB_1 oldMemB_2 oldMemB_3 oldMemB_4 oldMemB_5 oldMemB_6 oldMemB_7 vR7Old vR10Old oldMemD_8 oldMemD_9 oldMemB_10 oldMemD_11 oldMemD_12 vR4Old oldMemD_13 vR9Old oldMemB_14 vR5Old vR8Old vR3Old vR6Old oldMemB_15 oldMemB_16 oldMemD_17 oldMemD_18 oldMemD_19 oldMemD_20 oldMemD_21 addr0 addr1 addr2 addr3 addr4 addr5 h_addr0 h_addr1 h_addr2 h_addr3 h_addr4 h_addr5 holdMemB_0_lt holdMemB_1_lt holdMemB_2_lt holdMemB_3_lt holdMemB_4_lt holdMemB_5_lt holdMemB_6_lt holdMemB_7_lt holdMemD_9_lt holdMemD_12_lt holdMemD_13_lt holdMemD_17_lt holdMemD_18_lt holdMemD_19_lt holdMemD_20_lt holdMemD_21_lt h_branch0 h_branch1 h_branch2 h_branch3 h_branch4 h_branch5 h_branch6 h_branch7 h_branch8 h_branch9 h_branch10 h_branch11 h_branch12 h_branch13 h_branch14 h_branch15 h_branch16 h_branch17 h_branch18 h_branch19 h_branch20 h_branch21 h_branch22 h_branch23 h_branch24 h_branch25 h_branch26 h_branch27 h_branch28 h_branch29 h_branch30 h_branch31 h_branch32 h_branch33 h_branch34 h_branch35 h_branch36 h_branch37 h_branch38 hReloadLt_7173 h_alias_7173 h_alias_7174 hReloadLt_7182 h_alias_7182 nCuLog22 hCuLog22
...
#assert_std_axioms_local Examples.Lifted.PTokenRevokeOwnerMismatch.PTokenRevokeOwnerMismatch_lifted_spec
#assert_std_axioms_local Examples.PTokenRevokeOwnerMismatchGuard.p_token_revoke_owner_mismatch_enforced

end Examples.PTokenRevokeOwnerMismatchGuard

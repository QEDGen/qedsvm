/-
  Pattern library Layer 3 — the AUTHORITY-TYPE guard on the real p-token
  SetAuthority arm: a mint-flavored authority type (MintTokens) does not
  apply to a token account.

  From a pre where the instruction's authority_type byte is MintTokens but
  the target is a token account (the VIOLATION as hypothesis), the lifted
  error path runs to the shared exit with r0 = 15
  (TokenError::AuthorityTypeNotSupported), cells untouched.
-/

import Generated.PTokenSetAuthorityBadTypeLifted
import Lean
import SVM.Solana.Patterns.Guards

namespace Examples.PTokenSetAuthorityBadTypeGuard

open SVM.SBPF
open Memory
open Examples.Lifted.PTokenSetAuthorityBadType

set_option maxHeartbeats 1600000 in
/-- From a SetAuthority(MintTokens) aimed at a token account, the real
    p-token SetAuthority HALTS with `exitCode = some 15`
    (TokenError::AuthorityTypeNotSupported) — the authority-type check is
    ENFORCED. -/
theorem p_token_set_authority_bad_type_enforced
    ...
    : SVM.Solana.Patterns.EnforcedError (131 + 1) nCuLog20 198
      ...
      (effectiveAddr addr3 196 ↦ₘ oldMemB_17) **
      (effectiveAddr addr4 0 ↦U64 oldMemD_18) **
      (effectiveAddr addr5 0 ↦U64 oldMemD_19))
      (fun rt => ((((((((((((((((rt.containsRange (effectiveAddr baseAddr 0) 1 = true) ∧
                  ...
                  rt.containsRange (oldMemD_18) (oldMemD_19) = true)
      15 := by
  refine ⟨by decide, ?_⟩
  have h := PTokenSetAuthorityBadType_lifted_spec baseAddr oldMemB_0 vR2Old vR0Old oldMemB_1 oldMemB_2 oldMemB_3 oldMemB_4 oldMemB_5 oldMemB_6 oldMemB_7 vR7Old vR10Old oldMemD_8 oldMemD_9 oldMemB_10 oldMemD_11 oldMemD_12 vR4Old oldMemD_13 vR9Old oldMemB_14 vR5Old vR8Old vR3Old vR6Old oldMemB_15 oldMemB_16 oldMemB_17 oldMemD_18 oldMemD_19 addr0 addr1 addr2 addr3 addr4 addr5 h_addr0 h_addr1 h_addr2 h_addr3 h_addr4 h_addr5 holdMemB_0_lt holdMemB_1_lt holdMemB_2_lt holdMemB_3_lt holdMemB_4_lt holdMemB_5_lt holdMemB_6_lt holdMemB_7_lt holdMemD_9_lt holdMemD_12_lt holdMemD_13_lt holdMemD_18_lt holdMemD_19_lt h_branch0 h_branch1 h_branch2 h_branch3 h_branch4 h_branch5 h_branch6 h_branch7 h_branch8 h_branch9 h_branch10 h_branch11 h_branch12 h_branch13 h_branch14 h_branch15 h_branch16 h_branch17 h_branch18 h_branch19 h_branch20 h_branch21 h_branch22 h_branch23 h_branch24 h_branch25 h_branch26 h_branch27 h_branch28 h_branch29 h_branch30 h_branch31 h_branch32 h_branch33 h_branch34 h_branch35 h_branch36 h_branch37 h_branch38 h_branch39 h_branch40 h_branch41 h_branch42 hReloadLt_7689 h_alias_7689 h_alias_7690 nCuLog20 hCuLog20
  rw [show (((toU64 15) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)
        = 15 from by decide,
...
#assert_std_axioms_local Examples.Lifted.PTokenSetAuthorityBadType.PTokenSetAuthorityBadType_lifted_spec
#assert_std_axioms_local Examples.PTokenSetAuthorityBadTypeGuard.p_token_set_authority_bad_type_enforced

end Examples.PTokenSetAuthorityBadTypeGuard

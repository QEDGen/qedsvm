/-
  Pattern library Layer 3 — the NONZERO-BALANCE guard on the real p-token
  CloseAccount arm: an account still holding tokens cannot be closed
  (closing it would destroy the tokens and break the supply invariant).

  From a pre where the account balance is nonzero (the VIOLATION as
  hypothesis), the lifted error path runs to the shared exit with r0 = 11
  (TokenError::NonNativeHasBalance), cells untouched.
-/

import Generated.PTokenCloseAccountNonzeroLifted
import Lean
import SVM.Solana.Patterns.Guards

namespace Examples.PTokenCloseAccountNonzeroGuard

open SVM.SBPF
open Memory
open Examples.Lifted.PTokenCloseAccountNonzero

set_option maxHeartbeats 1600000 in
/-- From a token account with a nonzero balance, the real p-token
    CloseAccount HALTS with `exitCode = some 11`
    (TokenError::NonNativeHasBalance) — the zero-balance check is
    ENFORCED. -/
theorem p_token_close_account_nonzero_enforced
    (baseAddr oldMemB_0 vR2Old oldMemD_1 oldMemB_2 oldMemD_3 vR0Old oldMemB_4 oldMemB_5 oldMemB_6 oldMemB_7 oldMemB_8 oldMemB_9 oldMemB_10 vR7Old vR10Old oldMemD_11 vR3Old oldMemB_12 oldMemD_13 oldMemD_14 oldMemB_15 oldMemD_16 oldMemD_17 vR4Old oldMemD_18 vR9Old oldMemB_19 vR5Old vR8Old oldMemB_20 oldMemB_21 oldMemD_22 vR6Old oldMemD_23 oldMemD_24 : Nat)
    (addr0 : Nat)
    (addr1 : Nat)
    (addr2 : Nat)
    (addr3 : Nat)
    ...
    (h_addr5 : addr5 = wrapAdd (toU64 4295072816) ((((let shift := toU64 56 % 64; if (((((((toU64 11) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) < U64_MODULUS / 2 then (((((((toU64 11) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) >>> shift else (let shifted := (((((((toU64 11) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) >>> shift; let highBits := (U64_MODULUS - 1) - (U64_MODULUS / (2 ^ shift) - 1); (shifted ||| highBits) % U64_MODULUS))) <<< (toU64 3 % 64)) % U64_MODULUS))
    (h_addr6 : addr6 = wrapAdd (toU64 4295071984) ((((let shift := toU64 56 % 64; if (((((((toU64 11) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) < U64_MODULUS / 2 then (((((((toU64 11) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) >>> shift else (let shifted := (((((((toU64 11) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) >>> shift; let highBits := (U64_MODULUS - 1) - (U64_MODULUS / (2 ^ shift) - 1); (shifted ||| highBits) % U64_MODULUS))) <<< (toU64 3 % 64)) % U64_MODULUS))
    ...
    (h_branch20 : wrapAdd baseAddr (toU64 8) ≠ ((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS)
    (h_branch21 : oldMemD_1 = toU64 165)
    (h_branch22 : ¬ oldMemB_20 % 256 > toU64 2)
    (h_branch23 : oldMemB_20 % 256 ≠ toU64 0)
    (h_branch24 : oldMemB_21 % 256 ≠ toU64 1)
    (h_branch25 : oldMemD_22 ≠ toU64 0)
    ...
    (h_branch30 : (((toU64 11) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) < toU64 20)
    (h_branch31 : ((((((toU64 11) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) &&& toU64 27) % U64_MODULUS = toU64 26)
    ...
    (h_branch36 : (((toU64 11) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) ≠ toU64 0)
    (hReloadLt_3547 : ((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS < 2 ^ 64)
    (h_alias_3547 : effectiveAddr (vR10Old) (-2064) = effectiveAddr (wrapAdd vR10Old (toU64 (-2072))) (8))
    (h_alias_3550 : effectiveAddr (wrapAdd baseAddr (toU64 8)) (80) = effectiveAddr (baseAddr) (88))
    (nCuLog25 : Nat)
    (hCuLog25 : ∀ s : State, (step (.call .sol_log_) s).cuConsumed ≤ s.cuConsumed + nCuLog25)
    : SVM.Solana.Patterns.EnforcedError (113 + 1) nCuLog25 198
      (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((CodeReq.singleton 198 (.ldx .byte .r2 .r1 0)).union
        ...
        (CodeReq.singleton 4906 (.mov64 .r6 (.imm (0))))).union
        (CodeReq.singleton 4907 (.mov64 .r9 (.imm (11))))).union
        (CodeReq.singleton 4908 (.ja 3536))).union
      ...
      (effectiveAddr addr4 152 ↦U64 oldMemD_22) **
      (.r6 ↦ᵣ vR6Old) **
      ...
      11 := by
  refine ⟨by decide, ?_⟩
  have h := PTokenCloseAccountNonzero_lifted_spec baseAddr oldMemB_0 vR2Old oldMemD_1 oldMemB_2 oldMemD_3 vR0Old oldMemB_4 oldMemB_5 oldMemB_6 oldMemB_7 oldMemB_8 oldMemB_9 oldMemB_10 vR7Old vR10Old oldMemD_11 vR3Old oldMemB_12 oldMemD_13 oldMemD_14 oldMemB_15 oldMemD_16 oldMemD_17 vR4Old oldMemD_18 vR9Old oldMemB_19 vR5Old vR8Old oldMemB_20 oldMemB_21 oldMemD_22 vR6Old oldMemD_23 oldMemD_24 addr0 addr1 addr2 addr3 addr4 addr5 addr6 h_addr0 h_addr1 h_addr2 h_addr3 h_addr4 h_addr5 h_addr6 holdMemD_1_lt holdMemD_3_lt holdMemB_0_lt holdMemB_4_lt holdMemB_5_lt holdMemB_6_lt holdMemB_7_lt holdMemB_8_lt holdMemB_9_lt holdMemB_10_lt holdMemD_14_lt holdMemD_17_lt holdMemD_18_lt holdMemD_22_lt holdMemD_23_lt holdMemD_24_lt h_branch0 h_branch1 h_branch2 h_branch3 h_branch4 h_branch5 h_branch6 h_branch7 h_branch8 h_branch9 h_branch10 h_branch11 h_branch12 h_branch13 h_branch14 h_branch15 h_branch16 h_branch17 h_branch18 h_branch19 h_branch20 h_branch21 h_branch22 h_branch23 h_branch24 h_branch25 h_branch26 h_branch27 h_branch28 h_branch29 h_branch30 h_branch31 h_branch32 h_branch33 h_branch34 h_branch35 h_branch36 hReloadLt_3547 h_alias_3547 h_alias_3550 nCuLog25 hCuLog25
  rw [show (((toU64 11) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)
        = 11 from by decide,
...
#assert_std_axioms_local Examples.Lifted.PTokenCloseAccountNonzero.PTokenCloseAccountNonzero_lifted_spec
#assert_std_axioms_local Examples.PTokenCloseAccountNonzeroGuard.p_token_close_account_nonzero_enforced

end Examples.PTokenCloseAccountNonzeroGuard

/-
  Pattern library Layer 3 — the FREEZE-CAPABILITY guard on the real
  p-token FreezeAccount arm: a mint created without a freeze authority can
  never freeze accounts.

  From a pre where the mint's freeze-authority COption tag is None (the
  VIOLATION as hypothesis), the lifted error path runs to the shared exit
  with r0 = 16 (TokenError::MintCannotFreeze), the account state
  untouched.
-/

import Generated.PTokenFreezeCannotFreezeLifted
import Lean
import SVM.Solana.Patterns.Guards

namespace Examples.PTokenFreezeCannotFreezeGuard

open SVM.SBPF
open Memory
open Examples.Lifted.PTokenFreezeCannotFreeze

set_option maxHeartbeats 1600000 in
/-- From a mint with no freeze authority, the real p-token FreezeAccount
    HALTS with `exitCode = some 16` (TokenError::MintCannotFreeze) — the
    freeze-capability check is ENFORCED. -/
theorem p_token_freeze_cannot_freeze_enforced
    (baseAddr oldMemB_0 vR2Old oldMemD_1 oldMemB_2 oldMemD_3 vR0Old oldMemB_4 oldMemB_5 oldMemB_6 oldMemB_7 oldMemB_8 oldMemB_9 oldMemB_10 vR7Old vR10Old oldMemD_11 vR3Old oldMemB_12 oldMemD_13 oldMemD_14 oldMemB_15 oldMemD_16 oldMemD_17 vR4Old oldMemD_18 vR9Old oldMemB_19 vR5Old vR8Old vR6Old oldMemB_20 oldMemB_21 oldMemD_22 oldMemD_23 oldMemD_24 oldMemD_25 oldMemD_26 oldMemD_27 oldMemD_28 oldMemD_29 oldMemB_30 oldMemB_31 oldMemD_32 oldMemD_33 : Nat)
    (addr0 : Nat)
    (addr1 : Nat)
    (addr2 : Nat)
    (addr3 : Nat)
    ...
    (h_addr5 : addr5 = wrapAdd (toU64 4295072816) ((((let shift := toU64 56 % 64; if (((((((toU64 16) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) < U64_MODULUS / 2 then (((((((toU64 16) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) >>> shift else (let shifted := (((((((toU64 16) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) >>> shift; let highBits := (U64_MODULUS - 1) - (U64_MODULUS / (2 ^ shift) - 1); (shifted ||| highBits) % U64_MODULUS))) <<< (toU64 3 % 64)) % U64_MODULUS))
    (h_addr6 : addr6 = wrapAdd (toU64 4295071984) ((((let shift := toU64 56 % 64; if (((((((toU64 16) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) < U64_MODULUS / 2 then (((((((toU64 16) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) >>> shift else (let shifted := (((((((toU64 16) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) >>> shift; let highBits := (U64_MODULUS - 1) - (U64_MODULUS / (2 ^ shift) - 1); (shifted ||| highBits) % U64_MODULUS))) <<< (toU64 3 % 64)) % U64_MODULUS))
    ...
    (h_branch37 : (((toU64 0) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) ≠ toU64 26)
    ...
    (h_branch42 : (((toU64 16) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) < toU64 20)
    (h_branch43 : ((((((toU64 16) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) &&& toU64 27) % U64_MODULUS = toU64 26)
    ...
    (h_branch48 : (((toU64 16) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) ≠ toU64 0)
    ...
    (nCuLog34 : Nat)
    (hCuLog34 : ∀ s : State, (step (.call .sol_log_) s).cuConsumed ≤ s.cuConsumed + nCuLog34)
    : SVM.Solana.Patterns.EnforcedError (161 + 1) nCuLog34 198
      (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((CodeReq.singleton 198 (.ldx .byte .r2 .r1 0)).union
        ...
        (CodeReq.singleton 9186 (.mov64 .r1 (.imm (16))))).union
        (CodeReq.singleton 9187 (.ja 9248))).union
      ...
      (effectiveAddr addr5 0 ↦U64 oldMemD_32) **
      (effectiveAddr addr6 0 ↦U64 oldMemD_33) ** callStackIs [])
      ((.r0 ↦ᵣ 16) ** callStackIs [] **
      (.r1 ↦ᵣ 0) **
      (effectiveAddr baseAddr 0 ↦ₘ oldMemB_0) **
      (.r2 ↦ᵣ toU64 16) **
      ...
      (effectiveAddr addr0 134 ↦ₘ oldMemB_31) **
      (effectiveAddr addr5 0 ↦U64 oldMemD_32) **
      (effectiveAddr addr6 0 ↦U64 oldMemD_33))
      (fun rt => (((((((((((((((((((((((((((((((((rt.containsRange (effectiveAddr baseAddr 0) 1 = true) ∧
                  ...
                  rt.containsRange (oldMemD_32) (oldMemD_33) = true)
      16 := by
  refine ⟨by decide, ?_⟩
  have h := PTokenFreezeCannotFreeze_lifted_spec baseAddr oldMemB_0 vR2Old oldMemD_1 oldMemB_2 oldMemD_3 vR0Old oldMemB_4 oldMemB_5 oldMemB_6 oldMemB_7 oldMemB_8 oldMemB_9 oldMemB_10 vR7Old vR10Old oldMemD_11 vR3Old oldMemB_12 oldMemD_13 oldMemD_14 oldMemB_15 oldMemD_16 oldMemD_17 vR4Old oldMemD_18 vR9Old oldMemB_19 vR5Old vR8Old vR6Old oldMemB_20 oldMemB_21 oldMemD_22 oldMemD_23 oldMemD_24 oldMemD_25 oldMemD_26 oldMemD_27 oldMemD_28 oldMemD_29 oldMemB_30 oldMemB_31 oldMemD_32 oldMemD_33 addr0 addr1 addr2 addr3 addr4 addr5 addr6 h_addr0 h_addr1 h_addr2 h_addr3 h_addr4 h_addr5 h_addr6 holdMemD_1_lt holdMemD_3_lt holdMemB_0_lt holdMemB_4_lt holdMemB_5_lt holdMemB_6_lt holdMemB_7_lt holdMemB_8_lt holdMemB_9_lt holdMemB_10_lt holdMemD_14_lt holdMemD_17_lt holdMemD_18_lt holdMemD_22_lt holdMemD_23_lt holdMemD_24_lt holdMemD_25_lt holdMemD_26_lt holdMemD_27_lt holdMemD_28_lt holdMemD_29_lt holdMemD_32_lt holdMemD_33_lt h_branch0 h_branch1 h_branch2 h_branch3 h_branch4 h_branch5 h_branch6 h_branch7 h_branch8 h_branch9 h_branch10 h_branch11 h_branch12 h_branch13 h_branch14 h_branch15 h_branch16 h_branch17 h_branch18 h_branch19 h_branch20 h_branch21 h_branch22 h_branch23 h_branch24 h_branch25 h_branch26 h_branch27 h_branch28 h_branch29 h_branch30 h_branch31 h_branch32 h_branch33 h_branch34 h_branch35 h_branch36 h_branch37 h_branch38 h_branch39 h_branch40 h_branch41 h_branch42 h_branch43 h_branch44 h_branch45 h_branch46 h_branch47 h_branch48 hReloadLt_7038 h_alias_7038 h_alias_7039 hReloadLt_7052 nCuLog34 hCuLog34
  rw [show (((toU64 16) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)
        = 16 from by decide,
...
#assert_std_axioms_local Examples.Lifted.PTokenFreezeCannotFreeze.PTokenFreezeCannotFreeze_lifted_spec
#assert_std_axioms_local Examples.PTokenFreezeCannotFreezeGuard.p_token_freeze_cannot_freeze_enforced

end Examples.PTokenFreezeCannotFreezeGuard

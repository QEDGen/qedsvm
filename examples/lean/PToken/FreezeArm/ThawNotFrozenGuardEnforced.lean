/-
  Pattern library Layer 3 — the STATE-TRANSITION guard on the real
  p-token ThawAccount arm: thawing a non-frozen account is rejected (the
  mirror of `AlreadyFrozenGuardEnforced.lean`).

  From an initialized (non-frozen) account (the VIOLATION as hypothesis,
  with a VALID freeze authority signing), the lifted error path runs to
  the shared exit with r0 = 13 (TokenError::InvalidState), the state byte
  untouched.
-/

import Generated.PTokenThawNotFrozenLifted
import Lean
import SVM.Solana.Patterns.Guards

namespace Examples.PTokenThawNotFrozenGuard

open SVM.SBPF
open Memory
open Examples.Lifted.PTokenThawNotFrozen

set_option maxHeartbeats 1600000 in
/-- Thawing a non-frozen account, the real p-token ThawAccount HALTS with
    `exitCode = some 13` (TokenError::InvalidState) — the state-transition
    check is ENFORCED on the thaw side. -/
theorem p_token_thaw_not_frozen_enforced
    ...
    (h_branch22 : ((oldMemB_19 % 256) &&& toU64 255) % U64_MODULUS = toU64 11)
    (h_branch23 : ¬ oldMemB_0 + 256 * (oldMemB_4 + 256 * (oldMemB_5 + 256 * (oldMemB_6 + 256 * (oldMemB_7 + 256 * (oldMemB_8 + 256 * (oldMemB_9 + 256 * oldMemB_10)))))) < toU64 3)
    (h_branch24 : oldMemD_1 = toU64 165)
    (h_branch25 : ¬ oldMemB_20 % 256 > toU64 2)
    (h_branch26 : oldMemB_20 % 256 ≠ toU64 2)
    (h_branch27 : oldMemB_20 % 256 ≠ toU64 0)
    ...
    (hReloadLt_7345 : wrapAdd baseAddr (toU64 8) < 2 ^ 64)
    (h_alias_7345 : effectiveAddr (wrapAdd vR10Old (toU64 (-2072))) (0) = effectiveAddr (vR10Old) (-2072))
    (h_alias_7346 : effectiveAddr (wrapAdd baseAddr (toU64 8)) (80) = effectiveAddr (baseAddr) (88))
    (nCuLog23 : Nat)
    (hCuLog23 : ∀ s : State, (step (.call .sol_log_) s).cuConsumed ≤ s.cuConsumed + nCuLog23)
    : SVM.Solana.Patterns.EnforcedError (136 + 1) nCuLog23 198
      ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((CodeReq.singleton 198 (.ldx .byte .r2 .r1 0)).union
        ...
        (CodeReq.singleton 7201 (.jeq .r5 (.imm (11)) 7342))).union
        (CodeReq.singleton 7342 (.jlt .r2 (.imm (3)) 9247))).union
        (CodeReq.singleton 7343 (.mov64 .r0 (.imm (3))))).union
        (CodeReq.singleton 7344 (.mov64 .r1 (.imm (0))))).union
        (CodeReq.singleton 7345 (.ldx .dword .r3 .r6 0))).union
        (CodeReq.singleton 7346 (.ldx .dword .r4 .r3 80))).union
        (CodeReq.singleton 7347 (.jne .r4 (.imm (165)) 9248))).union
        (CodeReq.singleton 7348 (.ldx .byte .r4 .r3 196))).union
        (CodeReq.singleton 7349 (.jgt .r4 (.imm (2)) 9248))).union
        (CodeReq.singleton 7350 (.jeq .r4 (.imm (2)) 7739))).union
        (CodeReq.singleton 7351 (.mov64 .r0 (.imm (9))))).union
        (CodeReq.singleton 7352 (.jeq .r4 (.imm (0)) 9248))).union
...
#assert_std_axioms_local Examples.Lifted.PTokenThawNotFrozen.PTokenThawNotFrozen_lifted_spec
#assert_std_axioms_local Examples.PTokenThawNotFrozenGuard.p_token_thaw_not_frozen_enforced

end Examples.PTokenThawNotFrozenGuard

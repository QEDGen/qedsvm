/-
  Pattern library Layer 3 — the FREEZE-AUTHORITY guard on the real
  p-token FreezeAccount arm: only the mint's freeze authority may freeze.

  From a pre where the (signing) authority differs from the mint's stored
  freeze authority (the VIOLATION as hypothesis), the lifted error path
  runs to the shared exit with r0 = 4 (TokenError::OwnerMismatch), the
  account state untouched.
-/

import Generated.PTokenFreezeAuthorityMismatchLifted
import Lean
import SVM.Solana.Patterns.Guards

namespace Examples.PTokenFreezeAuthorityMismatchGuard

open SVM.SBPF
open Memory
open Examples.Lifted.PTokenFreezeAuthorityMismatch

set_option maxHeartbeats 1600000 in
/-- From a signing authority that is not the mint's freeze authority, the
    real p-token FreezeAccount HALTS with `exitCode = some 4`
    (TokenError::OwnerMismatch) — the freeze-authority check is
    ENFORCED. -/
theorem p_token_freeze_authority_mismatch_enforced
    (baseAddr oldMemB_0 vR2Old oldMemD_1 oldMemB_2 oldMemD_3 vR0Old oldMemB_4 oldMemB_5 oldMemB_6 oldMemB_7 oldMemB_8 oldMemB_9 oldMemB_10 vR7Old vR10Old oldMemD_11 vR3Old oldMemB_12 oldMemD_13 oldMemD_14 oldMemB_15 oldMemD_16 oldMemD_17 vR4Old oldMemD_18 vR9Old oldMemB_19 vR5Old vR8Old vR6Old oldMemB_20 oldMemB_21 oldMemD_22 oldMemD_23 oldMemD_24 oldMemD_25 oldMemD_26 oldMemD_27 oldMemD_28 oldMemD_29 oldMemB_30 oldMemB_31 oldMemD_32 oldMemD_33 oldMemD_34 oldMemD_35 : Nat)
    (addr0 : Nat)
    (addr1 : Nat)
    (addr2 : Nat)
    (addr3 : Nat)
    ...
    (h_addr5 : addr5 = wrapAdd (toU64 4295072816) ((((let shift := toU64 56 % 64; if (((((((toU64 4) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) < U64_MODULUS / 2 then (((((((toU64 4) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) >>> shift else (let shifted := (((((((toU64 4) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) >>> shift; let highBits := (U64_MODULUS - 1) - (U64_MODULUS / (2 ^ shift) - 1); (shifted ||| highBits) % U64_MODULUS))) <<< (toU64 3 % 64)) % U64_MODULUS))
    (h_addr6 : addr6 = wrapAdd (toU64 4295071984) ((((let shift := toU64 56 % 64; if (((((((toU64 4) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) < U64_MODULUS / 2 then (((((((toU64 4) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) >>> shift else (let shifted := (((((((toU64 4) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) <<< (toU64 24 % 64)) % U64_MODULUS) >>> shift; let highBits := (U64_MODULUS - 1) - (U64_MODULUS / (2 ^ shift) - 1); (shifted ||| highBits) % U64_MODULUS))) <<< (toU64 3 % 64)) % U64_MODULUS))
    ...
    (h_branch28 : oldMemB_20 % 256 ≠ toU64 0)
    (h_branch29 : oldMemB_21 % 256 ≠ toU64 1)
    (h_branch30 : oldMemD_23 = oldMemD_22)
    (h_branch31 : oldMemD_25 = oldMemD_24)
    (h_branch32 : oldMemD_27 = oldMemD_26)
    (h_branch33 : oldMemD_29 = oldMemD_28)
    (h_branch34 : oldMemD_14 = toU64 82)
    (h_branch35 : oldMemB_30 % 256 = toU64 1)
    (h_branch36 : oldMemB_31 % 256 = toU64 1)
    (h_branch37 : oldMemD_32 ≠ oldMemD_33)
    (h_branch38 : (((toU64 0) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) ≠ toU64 26)
    ...
    (h_branch43 : (((toU64 4) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) < toU64 20)
    (h_branch44 : ((((((toU64 4) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) &&& toU64 27) % U64_MODULUS = toU64 26)
    (h_branch45 : ¬ toSigned64 ((((toU64 0) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) > toSigned64 (toU64 12))
    (h_branch46 : toSigned64 ((((toU64 0) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) ≤ toSigned64 (toU64 5))
    (h_branch47 : ¬ toSigned64 ((((toU64 0) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) > toSigned64 (toU64 2))
    (h_branch48 : (((toU64 0) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) = toU64 0)
    (h_branch49 : (((toU64 4) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) ≠ toU64 0)
    ...
    (hReloadLt_7052 : ((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS < 2 ^ 64)
    (hReloadLt_7072 : ((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_14) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS < 2 ^ 64)
    (nCuLog36 : Nat)
    (hCuLog36 : ∀ s : State, (step (.call .sol_log_) s).cuConsumed ≤ s.cuConsumed + nCuLog36)
    : SVM.Solana.Patterns.EnforcedError (166 + 1) nCuLog36 198
      ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((CodeReq.singleton 198 (.ldx .byte .r2 .r1 0)).union
        ...
        (CodeReq.singleton 7044 (.mov64 .r0 (.imm (9))))).union
        (CodeReq.singleton 7045 (.jeq .r4 (.imm (0)) 9248))).union
        (CodeReq.singleton 7046 (.mov64 .r0 (.imm (0))))).union
        (CodeReq.singleton 7047 (.mov64 .r1 (.imm (10))))).union
        (CodeReq.singleton 7048 (.ldx .byte .r4 .r3 197))).union
        (CodeReq.singleton 7049 (.jeq .r4 (.imm (1)) 9248))).union
        (CodeReq.singleton 7050 (.mov64 .r1 (.imm (3))))).union
        (CodeReq.singleton 7051 (.ldx .dword .r4 .r3 88))).union
        (CodeReq.singleton 7052 (.ldx .dword .r5 .r6 8))).union
        (CodeReq.singleton 7053 (.ldx .dword .r7 .r5 8))).union
        (CodeReq.singleton 7054 (.jne .r7 (.reg .r4) 9248))).union
        (CodeReq.singleton 7055 (.ldx .dword .r4 .r3 96))).union
        (CodeReq.singleton 7056 (.ldx .dword .r7 .r5 16))).union
        (CodeReq.singleton 7057 (.jne .r7 (.reg .r4) 9248))).union
        (CodeReq.singleton 7058 (.ldx .dword .r4 .r3 104))).union
        (CodeReq.singleton 7059 (.ldx .dword .r7 .r5 24))).union
        (CodeReq.singleton 7060 (.jne .r7 (.reg .r4) 9248))).union
        (CodeReq.singleton 7061 (.ldx .dword .r4 .r3 112))).union
        (CodeReq.singleton 7062 (.ldx .dword .r7 .r5 32))).union
        (CodeReq.singleton 7063 (.jne .r7 (.reg .r4) 9248))).union
        (CodeReq.singleton 7064 (.mov64 .r1 (.imm (0))))).union
        (CodeReq.singleton 7065 (.ldx .dword .r4 .r5 80))).union
        (CodeReq.singleton 7066 (.jne .r4 (.imm (82)) 8476))).union
        (CodeReq.singleton 7067 (.ldx .byte .r4 .r5 133))).union
        (CodeReq.singleton 7068 (.jne .r4 (.imm (1)) 7762))).union
        (CodeReq.singleton 7069 (.ldx .byte .r1 .r5 134))).union
        (CodeReq.singleton 7070 (.jne .r1 (.imm (1)) 9186))).union
        (CodeReq.singleton 7071 (.ldx .dword .r1 .r5 138))).union
        (CodeReq.singleton 7072 (.ldx .dword .r4 .r6 16))).union
        (CodeReq.singleton 7073 (.ldx .dword .r0 .r4 8))).union
        (CodeReq.singleton 7074 (.jne .r1 (.reg .r0) 9696))).union
        (CodeReq.singleton 9696 (.mov64 .r0 (.imm (0))))).union
        (CodeReq.singleton 9697 (.mov64 .r1 (.imm (4))))).union
        (CodeReq.singleton 9698 (.ja 9248))).union
      ...
      (effectiveAddr addr4 197 ↦ₘ oldMemB_21) **
      (effectiveAddr addr4 88 ↦U64 oldMemD_22) **
      (effectiveAddr addr0 8 ↦U64 oldMemD_23) **
      (effectiveAddr addr4 96 ↦U64 oldMemD_24) **
      (effectiveAddr addr0 16 ↦U64 oldMemD_25) **
      (effectiveAddr addr4 104 ↦U64 oldMemD_26) **
      (effectiveAddr addr0 24 ↦U64 oldMemD_27) **
      (effectiveAddr addr4 112 ↦U64 oldMemD_28) **
      (effectiveAddr addr0 32 ↦U64 oldMemD_29) **
      (effectiveAddr addr0 133 ↦ₘ oldMemB_30) **
      (effectiveAddr addr0 134 ↦ₘ oldMemB_31) **
      (effectiveAddr addr0 138 ↦U64 oldMemD_32) **
      (effectiveAddr addr2 8 ↦U64 oldMemD_33) **
      (effectiveAddr addr5 0 ↦U64 oldMemD_34) **
      (effectiveAddr addr6 0 ↦U64 oldMemD_35) ** callStackIs [])
      ((.r0 ↦ᵣ 4) ** callStackIs [] **
      (.r1 ↦ᵣ 0) **
      (effectiveAddr baseAddr 0 ↦ₘ oldMemB_0) **
      (.r2 ↦ᵣ toU64 4) **
      ...
      (effectiveAddr addr2 8 ↦U64 oldMemD_33) **
      (effectiveAddr addr5 0 ↦U64 oldMemD_34) **
      (effectiveAddr addr6 0 ↦U64 oldMemD_35))
      (fun rt => ((((((((((((((((((((((((((((((((((((rt.containsRange (effectiveAddr baseAddr 0) 1 = true) ∧
                  ...
                  rt.containsRange (effectiveAddr addr0 134) 1 = true) ∧
                  rt.containsRange (effectiveAddr addr0 138) 8 = true) ∧
                  ...
                  rt.containsRange (oldMemD_34) (oldMemD_35) = true)
      4 := by
  refine ⟨by decide, ?_⟩
  have h := PTokenFreezeAuthorityMismatch_lifted_spec baseAddr oldMemB_0 vR2Old oldMemD_1 oldMemB_2 oldMemD_3 vR0Old oldMemB_4 oldMemB_5 oldMemB_6 oldMemB_7 oldMemB_8 oldMemB_9 oldMemB_10 vR7Old vR10Old oldMemD_11 vR3Old oldMemB_12 oldMemD_13 oldMemD_14 oldMemB_15 oldMemD_16 oldMemD_17 vR4Old oldMemD_18 vR9Old oldMemB_19 vR5Old vR8Old vR6Old oldMemB_20 oldMemB_21 oldMemD_22 oldMemD_23 oldMemD_24 oldMemD_25 oldMemD_26 oldMemD_27 oldMemD_28 oldMemD_29 oldMemB_30 oldMemB_31 oldMemD_32 oldMemD_33 oldMemD_34 oldMemD_35 addr0 addr1 addr2 addr3 addr4 addr5 addr6 h_addr0 h_addr1 h_addr2 h_addr3 h_addr4 h_addr5 h_addr6 holdMemD_1_lt holdMemD_3_lt holdMemB_0_lt holdMemB_4_lt holdMemB_5_lt holdMemB_6_lt holdMemB_7_lt holdMemB_8_lt holdMemB_9_lt holdMemB_10_lt holdMemD_14_lt holdMemD_17_lt holdMemD_18_lt holdMemD_22_lt holdMemD_23_lt holdMemD_24_lt holdMemD_25_lt holdMemD_26_lt holdMemD_27_lt holdMemD_28_lt holdMemD_29_lt holdMemD_32_lt holdMemD_33_lt holdMemD_34_lt holdMemD_35_lt h_branch0 h_branch1 h_branch2 h_branch3 h_branch4 h_branch5 h_branch6 h_branch7 h_branch8 h_branch9 h_branch10 h_branch11 h_branch12 h_branch13 h_branch14 h_branch15 h_branch16 h_branch17 h_branch18 h_branch19 h_branch20 h_branch21 h_branch22 h_branch23 h_branch24 h_branch25 h_branch26 h_branch27 h_branch28 h_branch29 h_branch30 h_branch31 h_branch32 h_branch33 h_branch34 h_branch35 h_branch36 h_branch37 h_branch38 h_branch39 h_branch40 h_branch41 h_branch42 h_branch43 h_branch44 h_branch45 h_branch46 h_branch47 h_branch48 h_branch49 hReloadLt_7038 h_alias_7038 h_alias_7039 hReloadLt_7052 hReloadLt_7072 nCuLog36 hCuLog36
...
#assert_std_axioms_local Examples.Lifted.PTokenFreezeAuthorityMismatch.PTokenFreezeAuthorityMismatch_lifted_spec
#assert_std_axioms_local Examples.PTokenFreezeAuthorityMismatchGuard.p_token_freeze_authority_mismatch_enforced

end Examples.PTokenFreezeAuthorityMismatchGuard

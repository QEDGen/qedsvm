...
/-- Local PC numbering: PCs 0-7 cover the 8 instructions; PC 0xf69
    is the target of the final `jeq` (PC 7 + 1 + 0xf61). Kept as a
    default-target hint; the `base`-parameterized variant below takes
...
theorem p_token_transfer_validation_prelude_spec
  ...
  -- the final jeq fires (taken) and goes to target.

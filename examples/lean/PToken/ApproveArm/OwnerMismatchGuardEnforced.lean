/-
  Pattern library Layer 3 — the OWNER guard on the real p-token Approve
  arm: only the account owner may delegate (a stranger could otherwise
  grant itself an allowance — the delegation-theft shape of the missing
  owner check).

  From a pre where the (signing) authority is not the account owner (the
  VIOLATION as hypothesis), the lifted error path runs to the shared exit
  with r0 = 4 (TokenError::OwnerMismatch), cells untouched.
-/

import Generated.PTokenApproveOwnerMismatchLifted
import Lean
import SVM.Solana.Patterns.Guards

namespace Examples.PTokenApproveOwnerMismatchGuard

open SVM.SBPF
open Memory
open Examples.Lifted.PTokenApproveOwnerMismatch

set_option maxHeartbeats 1600000 in
/-- From a signing non-owner, the real p-token Approve HALTS with
    `exitCode = some 4` (TokenError::OwnerMismatch) — the owner check is
    ENFORCED on the Approve arm. -/
theorem p_token_approve_owner_mismatch_enforced
    (baseAddr oldMemB_0 vR2Old oldMemD_1 oldMemB_2 oldMemD_3 vR0Old oldMemB_4 oldMemB_5 oldMemB_6 oldMemB_7 oldMemB_8 oldMemB_9 oldMemB_10 vR7Old vR10Old oldMemD_11 vR3Old oldMemB_12 oldMemD_13 oldMemD_14 oldMemB_15 oldMemD_16 oldMemD_17 vR4Old oldMemD_18 vR9Old oldMemB_19 vR5Old vR8Old vR6Old oldMemB_20 oldMemD_21 oldMemD_22 oldMemD_23 oldMemD_24 : Nat)
    (addr0 : Nat)
    (addr1 : Nat)
    (addr2 : Nat)
    (addr3 : Nat)
    ...
    (h_branch29 : oldMemD_21 ≠ oldMemD_22)
    (h_branch30 : (((toU64 0) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) ≠ toU64 26)
    ...
    (h_branch35 : (((toU64 4) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) < toU64 20)
    (h_branch36 : ((((((toU64 4) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) &&& toU64 27) % U64_MODULUS = toU64 26)
    (h_branch37 : ¬ toSigned64 ((((toU64 0) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) > toSigned64 (toU64 12))
    (h_branch38 : toSigned64 ((((toU64 0) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) ≤ toSigned64 (toU64 5))
    (h_branch39 : ¬ toSigned64 ((((toU64 0) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64)) > toSigned64 (toU64 2))
    (h_branch40 : (((toU64 0) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) = toU64 0)
    (h_branch41 : (((toU64 4) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) ≠ toU64 0)
    ...
    (hReloadLt_7370 : ((wrapAdd (wrapAdd (((wrapAdd (wrapAdd baseAddr oldMemD_1) (toU64 10351)) &&& toU64 (-8)) % U64_MODULUS) oldMemD_14) (toU64 10343)) &&& toU64 (-8)) % U64_MODULUS < 2 ^ 64)
    (nCuLog25 : Nat)
    (hCuLog25 : ∀ s : State, (step (.call .sol_log_) s).cuConsumed ≤ s.cuConsumed + nCuLog25)
    : SVM.Solana.Patterns.EnforcedError (139 + 1) nCuLog25 198
      (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((CodeReq.singleton 198 (.ldx .byte .r2 .r1 0)).union
        ...
        (CodeReq.singleton 7365 (.mov64 .r0 (.imm (9))))).union
        (CodeReq.singleton 7366 (.jeq .r5 (.imm (0)) 9248))).union
        (CodeReq.singleton 7367 (.mov64 .r0 (.imm (0))))).union
        (CodeReq.singleton 7368 (.mov64 .r1 (.imm (4))))).union
        (CodeReq.singleton 7369 (.ldx .dword .r7 .r4 120))).union
        (CodeReq.singleton 7370 (.ldx .dword .r5 .r6 16))).union
        (CodeReq.singleton 7371 (.ldx .dword .r8 .r5 8))).union
        (CodeReq.singleton 7372 (.jne .r7 (.reg .r8) 9248))).union
      ...
      (effectiveAddr addr4 120 ↦U64 oldMemD_21) **
      (effectiveAddr addr2 8 ↦U64 oldMemD_22) **
      ...
      4 := by
  refine ⟨by decide, ?_⟩
  have h := PTokenApproveOwnerMismatch_lifted_spec baseAddr oldMemB_0 vR2Old oldMemD_1 oldMemB_2 oldMemD_3 vR0Old oldMemB_4 oldMemB_5 oldMemB_6 oldMemB_7 oldMemB_8 oldMemB_9 oldMemB_10 vR7Old vR10Old oldMemD_11 vR3Old oldMemB_12 oldMemD_13 oldMemD_14 oldMemB_15 oldMemD_16 oldMemD_17 vR4Old oldMemD_18 vR9Old oldMemB_19 vR5Old vR8Old vR6Old oldMemB_20 oldMemD_21 oldMemD_22 oldMemD_23 oldMemD_24 addr0 addr1 addr2 addr3 addr4 addr5 addr6 h_addr0 h_addr1 h_addr2 h_addr3 h_addr4 h_addr5 h_addr6 holdMemD_1_lt holdMemD_3_lt holdMemB_0_lt holdMemB_4_lt holdMemB_5_lt holdMemB_6_lt holdMemB_7_lt holdMemB_8_lt holdMemB_9_lt holdMemB_10_lt holdMemD_14_lt holdMemD_17_lt holdMemD_18_lt holdMemD_21_lt holdMemD_22_lt holdMemD_23_lt holdMemD_24_lt h_branch0 h_branch1 h_branch2 h_branch3 h_branch4 h_branch5 h_branch6 h_branch7 h_branch8 h_branch9 h_branch10 h_branch11 h_branch12 h_branch13 h_branch14 h_branch15 h_branch16 h_branch17 h_branch18 h_branch19 h_branch20 h_branch21 h_branch22 h_branch23 h_branch24 h_branch25 h_branch26 h_branch27 h_branch28 h_branch29 h_branch30 h_branch31 h_branch32 h_branch33 h_branch34 h_branch35 h_branch36 h_branch37 h_branch38 h_branch39 h_branch40 h_branch41 hReloadLt_7359 h_alias_7359 h_alias_7360 hReloadLt_7370 nCuLog25 hCuLog25
...
#assert_std_axioms_local Examples.Lifted.PTokenApproveOwnerMismatch.PTokenApproveOwnerMismatch_lifted_spec
#assert_std_axioms_local Examples.PTokenApproveOwnerMismatchGuard.p_token_approve_owner_mismatch_enforced

end Examples.PTokenApproveOwnerMismatchGuard

/-
  Pattern library Layer 3 — the FROZEN guard on the real p-token Burn
  arm.

  From a frozen account (state byte = 2 — the VIOLATION as hypothesis),
  the lifted error path runs to the shared exit with r0 = 17
  (TokenError::AccountFrozen), cells untouched.
-/

import Generated.PTokenBurnFrozenLifted
import Lean
import SVM.Solana.Patterns.Guards

namespace Examples.PTokenBurnFrozenGuard

open SVM.SBPF
open Memory
open Examples.Lifted.PTokenBurnFrozen

set_option maxHeartbeats 1600000 in
/-- From a frozen account, the real p-token Burn HALTS with
    `exitCode = some 17` (AccountFrozen) — the frozen check is ENFORCED on
    the Burn arm. -/
theorem p_token_burn_frozen_enforced
    (baseAddr oldMemB_0 vR2Old oldMemD_1 oldMemB_2 oldMemD_3 vR0Old oldMemB_4 oldMemB_5 oldMemB_6 oldMemB_7 oldMemB_8 oldMemB_9 oldMemB_10 vR7Old vR10Old oldMemD_11 vR3Old oldMemB_12 oldMemD_13 oldMemD_14 oldMemB_15 oldMemD_16 oldMemD_17 vR4Old oldMemD_18 vR9Old oldMemB_19 vR5Old vR8Old vR6Old oldMemB_20 oldMemB_21 oldMemD_22 oldMemD_23 : Nat)
    (addr0 : Nat)
    (addr1 : Nat)
    (addr2 : Nat)
    (addr3 : Nat)
    ...
    (h_branch30 : (((toU64 17) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) < toU64 20)
    (h_branch31 : ((((((toU64 17) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) &&& toU64 27) % U64_MODULUS = toU64 26)
    ...
    (h_branch36 : (((toU64 17) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) ≠ toU64 0)
    ...
    : SVM.Solana.Patterns.EnforcedError (113 + 1) nCuLog24 198
      ...
      17 := by
  refine ⟨by decide, ?_⟩
  have h := PTokenBurnFrozen_lifted_spec baseAddr oldMemB_0 vR2Old oldMemD_1 oldMemB_2 oldMemD_3 vR0Old oldMemB_4 oldMemB_5 oldMemB_6 oldMemB_7 oldMemB_8 oldMemB_9 oldMemB_10 vR7Old vR10Old oldMemD_11 vR3Old oldMemB_12 oldMemD_13 oldMemD_14 oldMemB_15 oldMemD_16 oldMemD_17 vR4Old oldMemD_18 vR9Old oldMemB_19 vR5Old vR8Old vR6Old oldMemB_20 oldMemB_21 oldMemD_22 oldMemD_23 addr0 addr1 addr2 addr3 addr4 addr5 addr6 h_addr0 h_addr1 h_addr2 h_addr3 h_addr4 h_addr5 h_addr6 holdMemD_1_lt holdMemD_3_lt holdMemB_0_lt holdMemB_4_lt holdMemB_5_lt holdMemB_6_lt holdMemB_7_lt holdMemB_8_lt holdMemB_9_lt holdMemB_10_lt holdMemD_14_lt holdMemD_17_lt holdMemD_18_lt holdMemD_22_lt holdMemD_23_lt h_branch0 h_branch1 h_branch2 h_branch3 h_branch4 h_branch5 h_branch6 h_branch7 h_branch8 h_branch9 h_branch10 h_branch11 h_branch12 h_branch13 h_branch14 h_branch15 h_branch16 h_branch17 h_branch18 h_branch19 h_branch20 h_branch21 h_branch22 h_branch23 h_branch24 h_branch25 h_branch26 h_branch27 h_branch28 h_branch29 h_branch30 h_branch31 h_branch32 h_branch33 h_branch34 h_branch35 h_branch36 h_alias_3792 hReloadLt_3797 h_alias_3797 nCuLog24 hCuLog24
...
#assert_std_axioms_local Examples.Lifted.PTokenBurnFrozen.PTokenBurnFrozen_lifted_spec
#assert_std_axioms_local Examples.PTokenBurnFrozenGuard.p_token_burn_frozen_enforced

end Examples.PTokenBurnFrozenGuard

/-
  Pattern library Layer 3 — the DELEGATED-AMOUNT guard: a properly
  signing delegate whose remaining allowance is smaller than the transfer
  amount must fail, even though the source balance itself is sufficient.
  A distinct check (and distinct cell, delegated_amount@121) from the
  source-balance guard in `BalanceGuardEnforced.lean`.

  From a pre where the delegate's allowance is below the transfer amount
  (the VIOLATION as hypothesis), the lifted error path runs to the shared
  exit with r0 = 1 (TokenError::InsufficientFunds), token cells
  untouched.
-/

import Generated.PTokenTransferDelegateInsufficientLifted
import Lean
import SVM.Solana.Patterns.Guards

namespace Examples.PTokenDelegateInsufficientGuardEnforced

open SVM.SBPF
open Memory
open Examples.Lifted.PTokenTransferDelegateInsufficient

set_option maxHeartbeats 1600000 in
/-- From a signing delegate whose allowance is below the transfer amount,
    the real p-token Transfer HALTS with `exitCode = some 1`
    (TokenError::InsufficientFunds) — the delegated-amount check is
    ENFORCED. -/
theorem p_token_delegate_insufficient_enforced
    (baseAddr oldMemB_0 vR2Old oldMemD_1 oldMemB_2 oldMemD_3 oldMemB_4 oldMemD_5 vR4Old vR3Old oldMemD_6 oldMemB_7 vR6Old vR7Old oldMemB_8 oldMemB_9 vR5Old oldMemD_10 oldMemD_11 oldMemD_12 oldMemD_13 vR0Old oldMemD_14 oldMemD_15 oldMemD_16 oldMemD_17 oldMemD_18 oldMemD_19 oldMemD_20 oldMemB_21 oldMemD_22 oldMemD_23 oldMemD_24 vR8Old oldMemD_25 oldMemD_26 oldMemD_27 oldMemD_28 oldMemB_29 oldMemD_30 vR9Old vR10Old oldMemD_31 oldMemD_32 : Nat)
    (addr0 : Nat)
    (addr1 : Nat)
    (addr2 : Nat)
    ...
    (h_branch25 : oldMemD_30 < oldMemD_10)
    ...
    (h_branch30 : (((toU64 1) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) < toU64 20)
    (h_branch31 : ((((((toU64 1) <<< (toU64 32 % 64)) % U64_MODULUS) ||| toU64 26) % U64_MODULUS) &&& toU64 27) % U64_MODULUS = toU64 26)
    ...
    (h_branch36 : (((toU64 1) <<< (toU64 32 % 64)) % U64_MODULUS) >>> (toU64 32 % 64) ≠ toU64 0)
    (nCuLog33 : Nat)
    (hCuLog33 : ∀ s : State, (step (.call .sol_log_) s).cuConsumed ≤ s.cuConsumed + nCuLog33)
    : SVM.Solana.Patterns.EnforcedError (111 + 1) nCuLog33 198
      (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((CodeReq.singleton 198 (.ldx .byte .r2 .r1 0)).union
        ...
        (CodeReq.singleton 5217 (.ldx .dword .r4 .r1 217))).union
        (CodeReq.singleton 5218 (.jlt .r4 (.reg .r2) 4725))).union
      ...
      (effectiveAddr baseAddr 217 ↦U64 oldMemD_30) **
      (.r9 ↦ᵣ vR9Old) **
      (.r10 ↦ᵣ vR10Old) **
      (effectiveAddr addr1 0 ↦U64 oldMemD_31) **
      (effectiveAddr addr2 0 ↦U64 oldMemD_32) ** callStackIs [])
      ((.r0 ↦ᵣ 1) ** callStackIs [] **
      (.r1 ↦ᵣ 0) **
      (effectiveAddr baseAddr 0 ↦ₘ oldMemB_0) **
      (.r2 ↦ᵣ toU64 1) **
      ...
      (.r10 ↦ᵣ vR10Old) **
      (effectiveAddr addr1 0 ↦U64 oldMemD_31) **
      (effectiveAddr addr2 0 ↦U64 oldMemD_32))
      (fun rt => (((((((((((((((((((((((((((((((((rt.containsRange (effectiveAddr baseAddr 0) 1 = true) ∧
                  ...
                  rt.containsRange (effectiveAddr baseAddr 217) 8 = true) ∧
                  rt.containsRange (effectiveAddr addr1 0) 8 = true) ∧
                  rt.containsRange (effectiveAddr addr2 0) 8 = true) ∧
                  rt.containsRange (oldMemD_31) (oldMemD_32) = true)
      1 := by
  refine ⟨by decide, ?_⟩
  have h := PTokenTransferDelegateInsufficient_lifted_spec baseAddr oldMemB_0 vR2Old oldMemD_1 oldMemB_2 oldMemD_3 oldMemB_4 oldMemD_5 vR4Old vR3Old oldMemD_6 oldMemB_7 vR6Old vR7Old oldMemB_8 oldMemB_9 vR5Old oldMemD_10 oldMemD_11 oldMemD_12 oldMemD_13 vR0Old oldMemD_14 oldMemD_15 oldMemD_16 oldMemD_17 oldMemD_18 oldMemD_19 oldMemD_20 oldMemB_21 oldMemD_22 oldMemD_23 oldMemD_24 vR8Old oldMemD_25 oldMemD_26 oldMemD_27 oldMemD_28 oldMemB_29 oldMemD_30 vR9Old vR10Old oldMemD_31 oldMemD_32 addr0 addr1 addr2 h_addr0 h_addr1 h_addr2 holdMemD_1_lt holdMemD_3_lt holdMemD_5_lt holdMemD_6_lt holdMemD_10_lt holdMemD_11_lt holdMemD_12_lt holdMemD_13_lt holdMemD_14_lt holdMemD_15_lt holdMemD_16_lt holdMemD_17_lt holdMemD_18_lt holdMemD_19_lt holdMemD_20_lt holdMemD_22_lt holdMemD_23_lt holdMemD_24_lt holdMemD_25_lt holdMemD_26_lt holdMemD_27_lt holdMemD_28_lt holdMemD_30_lt holdMemD_31_lt holdMemD_32_lt h_branch0 h_branch1 h_branch2 h_branch3 h_branch4 h_branch5 h_branch6 h_branch7 h_branch8 h_branch9 h_branch10 h_branch11 h_branch12 h_branch13 h_branch14 h_branch15 h_branch16 h_branch17 h_branch18 h_branch19 h_branch20 h_branch21 h_branch22 h_branch23 h_branch24 h_branch25 h_branch26 h_branch27 h_branch28 h_branch29 h_branch30 h_branch31 h_branch32 h_branch33 h_branch34 h_branch35 h_branch36 nCuLog33 hCuLog33
...
#assert_std_axioms_local Examples.Lifted.PTokenTransferDelegateInsufficient.PTokenTransferDelegateInsufficient_lifted_spec
#assert_std_axioms_local Examples.PTokenDelegateInsufficientGuardEnforced.p_token_delegate_insufficient_enforced

end Examples.PTokenDelegateInsufficientGuardEnforced
